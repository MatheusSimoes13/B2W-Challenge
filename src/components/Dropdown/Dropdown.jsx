...
const Dropdown = () => {
  ...
  return (
    <div>
      <span onClick={() => setIsOpen(true)} className={isOpen ? '' : `flex items-center gap-2 cursor-pointer`}>following 5 users <IoIosArrowDown /></span>
      <div className={isOpen ? 'animate-showUl w-full bg-white p-2 absolute top-0 right-0 md:w-3/5 md:mr-16 md:mt-3' : ' hidden'}>
